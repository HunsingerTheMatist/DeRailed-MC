...
execute if score #curr_item dr_arg = $Rail dr_const run \
    summon minecraft:item_display ~ ~ ~ {item: {id:"rail",       components: {item_model:"derailed:rail"}}, transformation: {left_rotation:[0,0,0,1], right_rotation:[0,0,0,1], scale:[1,1,1], translation:[0,0,0]}, Tags:["dr_placement"]}
...
execute if score #curr_item dr_arg matches 4 run \
    summon minecraft:item_display ~ ~ ~ {item: {id:"oak_log",    components: {item_model:"derailed:_small_wood"}}, transformation: {left_rotation:[0,0,0,1], right_rotation:[0,0,0,1], scale:[1,1,1], translation:[0,0,0]}, Tags:["dr_placement"]}
execute if score #curr_item dr_arg matches 5 run \
    summon minecraft:item_display ~ ~ ~ {item: {id:"iron_block", components: {item_model:"derailed:_small_iron"}}, transformation: {left_rotation:[0,0,0,1], right_rotation:[0,0,0,1], scale:[1,1,1], translation:[0,0,0]}, Tags:["dr_placement"]}
