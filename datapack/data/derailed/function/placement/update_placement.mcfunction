...
execute if score #curr_item dr_arg <= $LastResource dr_const store result entity @s height float 0.01 run scoreboard players operation #stack_height dr_temp *= $PlacementHeight dr_const
