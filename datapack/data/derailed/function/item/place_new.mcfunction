...
#
# Args: #curr_item, #curr_item_count, #curr_rotation
...
# The placement starts facing #curr_rotation, snapped to 90 degree steps
...
scoreboard players operation #rotation dr_temp = #curr_rotation dr_arg
